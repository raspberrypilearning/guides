...
Here is the anemometer sensor supplied with the Raspberry Pi Weather Station kit, it is used to measure wind speed.

![Anemometer](images/anemometer.jpg)

## How does it work?

Essentially the wind catches the three cups and drives them round, spinning the central section.

To help explain how the device works, you can dismantle it following these steps:
First, hold the base in one hand and pull on the blades/cups with the other hand. It doesn't need much force to come off.
...
Now use a screwdriver to remove the three screws on the bottom of the base. The base should then pop out easily. Slide it down the cable about 10 to 20 cm to get it out of the way. Now if you look inside you'll see our old friend the reed switch again.
